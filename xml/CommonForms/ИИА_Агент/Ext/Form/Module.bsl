...
Перем ПоследнийКлючПодтверждения;
...
Процедура ОбработатьЗапросПодтверждения(ДанныеСообщения)
	...
	КонецЕсли;
	Если ПоследнийКлючПодтверждения = КлючПодтверждения Тогда
		ОбновитьПанельПодтверждения();
		Возврат;
	КонецЕсли;
	ПоследнийКлючПодтверждения = КлючПодтверждения;
	ОбновитьПанельПодтверждения();
