...
Функция ОркестраторПодтвердитьОжидающееДействие(СсылкаДиалога) Экспорт
	Возврат ИИА_Оркестратор.ПодтвердитьОжидающееДействие(СсылкаДиалога);
КонецФункции

Функция ОркестраторОтклонитьОжидающееДействие(СсылкаДиалога) Экспорт
	Возврат ИИА_Оркестратор.ОтклонитьОжидающееДействие(СсылкаДиалога);
КонецФункции

Функция ОркестраторВыполнятьБезПодтверждения(СсылкаДиалога) Экспорт
	Возврат ИИА_Оркестратор.ВключитьРежимБезПодтвержденияИПродолжить(СсылкаДиалога);
КонецФункции
