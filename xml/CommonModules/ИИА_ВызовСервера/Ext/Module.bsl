...
Функция ДобавитьВложениеИзФайла(СсылкаДиалога, ПутьКФайлу) Экспорт
	Возврат ИИА_Сервер.ДобавитьВложениеИзФайла(СсылкаДиалога, ПутьКФайлу);
КонецФункции

Функция ДобавитьВложениеИзДвоичныхДанных(СсылкаДиалога, ИмяФайла, ДвоичныеДанныеФайла) Экспорт
	Возврат ИИА_Сервер.ДобавитьВложениеИзДвоичныхДанных(СсылкаДиалога, ИмяФайла, ДвоичныеДанныеФайла);
КонецФункции

Функция ДобавитьВложениеИзВременногоХранилища(СсылкаДиалога, ИмяФайла, АдресВременногоХранилища) Экспорт
	Возврат ИИА_Сервер.ДобавитьВложениеИзВременногоХранилища(СсылкаДиалога, ИмяФайла, АдресВременногоХранилища);
КонецФункции

Функция ПолучитьВложенияДиалога(СсылкаДиалога) Экспорт
	Возврат ИИА_Сервер.ПолучитьВложенияДиалога(СсылкаДиалога);
КонецФункции

Функция ПолучитьПолныйТекстВложения(СсылкаДиалога, ИдентификаторИлиИмя = "") Экспорт
	Возврат ИИА_Сервер.ПолучитьПолныйТекстВложения(СсылкаДиалога, ИдентификаторИлиИмя);
КонецФункции

Функция НайтиВоВложениях(СсылкаДиалога, ИскомыйТекст, Лимит = 20, ИдентификаторИлиИмя = "") Экспорт
	Возврат ИИА_Сервер.НайтиВоВложениях(СсылкаДиалога, ИскомыйТекст, Лимит, ИдентификаторИлиИмя);
КонецФункции
